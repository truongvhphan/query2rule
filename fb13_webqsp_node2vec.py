...
fb_question_rules = 'data/WebQSP_question_rules.csv'
webqsp_question_ner = 'data/fb_WebQSP_question.csv'
max_length = 384
...
with open(webqsp_question_ner, 'r', encoding='utf-8') as f:
    data = csv.reader(f, delimiter='\t')
    for d in data:
        question_ner.append([d[0], d[2]])

embeddings = np.loadtxt(embedding_ent384, delimiter=' ')
